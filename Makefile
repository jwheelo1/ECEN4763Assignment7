...
clean:
	rm -rf test/insertionsort/__pycache__ # remove compiled python directory
	rm -rf sort/insertionsort/__pycache__ # remove compiled python directory
	rm -rf test/mergesort/__pycache__ # remove compiled python directory
	rm -rf sort/mergesort/__pycache__ # remove compiled python directory
	rm -rf test/quicksort/__pycache__ # remove compiled python directory
	rm -rf sort/quicksort/__pycache__ # remove compiled python directory
